        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
					...
					$payload = file_get_contents('http://localhost/workshop/i/insert_picture/'.$file->name);
                }
            } else {
            ...
            if ($success) {
                foreach($this->options['image_versions'] as $version => $options) {
                    if (!empty($version)) {
                        ...
                        if (is_file($file)) {
							unlink($file);
							$payload=file_get_contents('http://localhost/workshop/i/delete_picture/'.$file_name);
                        }
                    }
                }
            }
