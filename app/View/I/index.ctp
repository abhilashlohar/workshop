		...
		<div class="portlet light bordered">
				<div class="portlet-title">
					<div class="caption font-green-sharp">
						...
						<span class="caption-subject bold uppercase"> Photo Gallery</span>
					</div>
					<div class="actions">
						<a href="<?php echo $webroot_path; ?>i/picture" class="btn btn-circle btn-default btn-sm">
			...
			<!--<div class="portlet light bordered">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo $webroot_path; ?>i/selfies" class="btn btn-circle btn-default btn-sm">
						<i class="fa fa-search"></i> See More </a>
					</div>
				</div>
				<div class="portlet-body" style=" overflow: auto; ">
