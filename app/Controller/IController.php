...
function videos2(){
	...
	$this->loadmodel('youtube_video');
	$this->set('current_video',$this->youtube_video->find('all',array('conditions'=>array('id'=>$vid))));
	
	$this->loadmodel('youtube_video');
	$order=array('youtube_video.id'=>'DESC');
	$this->set('videos',$this->youtube_video->find('all', array('order' => $order)));
...
function embed_video(){
	...
	if (isset($this->request->data['sub'])){
		...
		$title=$_POST['title'];
		$strg=explode("=",$url);
		$this->loadmodel('youtube_videos');
		$this->youtube_videos->saveAll(Array( Array("title" => $title,"url" => $url,"vid" => $strg[1]))); 
	}
	
	$this->loadmodel('youtube_video');
	$order=array('youtube_video.id'=>'DESC');
	$this->set('youtube_videos',$this->youtube_video->find('all', array('order' => $order)));
}
...
function delete_yvideo($row_id=null){
	$this->layout="";
	
	$this->loadmodel('youtube_video');
	$conditions4=array('id'=>$row_id);
	$this->youtube_video->deleteAll($conditions4);
	$this->redirect(array('action' => 'embed_video'));
}
...
function menus(){
	...
	?>
	<li class="start">
		<a href="<?php echo $webroot_path; ?>i/index" style="text-align: center;color: #FFF;">
	...
	<li>
		<a href="<?php echo $webroot_path; ?>i/picture" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
	...
	<!--<li>
		<a href="<?php echo $webroot_path; ?>i/selfies" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
		<i class="fa fa-file-picture-o" style="font-size: 26px;color: #fcb82e;"></i><br>
	...
	<li >
		<a href="<?php echo $webroot_path; ?>i/videos2" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
	...
	<!--<li >
		<a href="<?php echo $webroot_path; ?>i/logout" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
	...
	<?php if(!empty($ws_user_id)){ ?>
	<li >
		<a href="<?php echo $webroot_path; ?>i/add_picture" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
		<i class="fa fa-plus" style="font-size: 26px;color: #fcb82e;"></i><br>
		<span class="title" style="font-size: 14px;">Add Pictures</span>
		<div style=" height: 8px; "></div>
		</a>
	</li>
	<li >
		<a href="<?php echo $webroot_path; ?>i/embed_video" style="text-align: center;color: #FFF;">
		<div style=" height: 8px; "></div>
		<i class="fa fa-plus" style="font-size: 26px;color: #fcb82e;"></i><br>
		<span class="title" style="font-size: 14px;">Add Videos</span>
		<div style=" height: 8px; "></div>
		</a>
	</li>
	<?php } ?>
...
function user_name(){
	...
	?>
	<div class="username username-hide-on-mobile" style="color: #0a1942;font-weight: bold;margin-top: 15px;">
		<?php echo $name; ?> </div>
	<?php */
	?>
	<div class="username username-hide-on-mobile" style="color: #0a1942;font-weight: bold;margin-top: 15px;">
		<a href="<?php echo $webroot_path; ?>i/login">Login</a> </div>
		<?php
}
